<form method="POST" action="{{route('profiles.update',["profile"=>$userDetail->profile->id])}}" enctype='multipart/form-data'>
    @csrf
    @method("PUT")
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group">
                                ...
                                <textarea name="bio" rows="4" class="form-control" placeholder="A few words about you ...">{{$userDetail->profile->bio}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
